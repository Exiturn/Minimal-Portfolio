        ...
        <div id='Contact' className='flex flex-col justify-start items-start px-5 pb-5 md:px-[10vw] min-w-[100vw] min-h-auto md:min-h-[100vh] mt-[6rem]'>
            ...
            <div className='flex flex-col md:flex-row justify-between w-full md:w-[80%] mt-4 gap-y-2 gap-x-[10rem]'>
                <p className='flex flex-row justify-start items-center gap-x-4 md:w-[30%]'>
                    ...
                    <a className='italic underline' href="https://linkedin.com/in/bryan-magistrado" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>linkedin.com/bryan-magistrado</a>
                </p>
                <p className='flex flex-row justify-start items-center gap-x-4 md:w-[40%]'>
                    <img className='w-[40px] md:w-[35px]' src={github} alt="github" />
                    <a className='italic underline' href="https://github.com/Exiturn" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>github.com/Exiturn</a>
                </p>
            </div>
            ...
            >
                <div className='flex flex-col md:flex-row justify-between md:gap-x-[10rem] w-full'>
                    <div className='md:w-[30%]'>
                        <label className='flex flex-col mt-4 pointer-events-none'>Name</label>
                        <input
                            type='text'
                            name='name'
                            value={form.name}
                    ...
                    <div className='md:w-[40%]'>
                        <label className='flex flex-col mt-4 pointer-events-none'>Email</label>
                        <input
                            type='text'
                            name='email'
                            value={form.email}
