...
const projects = [
  {
    ...
    fullDescription: `This level 3 frontend challenge was a fun one. Not only was it of a website I already know from scouting pretty but minimal web designs, but because it also matches the exact design aesthtic I want to craft. I happened to come across this challenge on Frontend Mentor one day and it has been a great way to dissect and reverse engineer how one of my inspirational websites is developed. Design wise, I have learned a lot from deep diving into how they integrated some of their frontend features like their colour transition which I am still trying to figure out. All in all, it has been a whole lot of fun and more improvements to be made in future updates such as page transitions and menu animations.`,
    id: "advmnstry",
    ...
    learned: `Creating this project was a lot of fun, it truly made my inner web designer happy to be able to work with such a beautifully made website. Especially this time, being able to
       understand implementation methods of the features. It still proves to be a challenge which I appreciate as I am still trying to figure out the last transition animation.`,
